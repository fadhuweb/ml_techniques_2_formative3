...
experiments = [
    ...
    {"lr": 3e-4, "gamma": 0.99, "batch": 32, "eps_start": 1.0, "eps_end": 0.05, "eps_frac": 0.1},

    # Experiment 3 - Lower gamma
    {"lr": 1e-4, "gamma": 0.90, "batch": 32, "eps_start": 1.0, "eps_end": 0.05, "eps_frac": 0.1},

    # Experiment 4 - Larger batch
    {"lr": 1e-4, "gamma": 0.99, "batch": 48, "eps_start": 1.0, "eps_end": 0.05, "eps_frac": 0.1},
    ...
    {"lr": 1e-4, "gamma": 0.99, "batch": 32, "eps_start": 1.0, "eps_end": 0.2, "eps_frac": 0.1},

    # Experiment 7 - Less exploration
    {"lr": 1e-4, "gamma": 0.99, "batch": 32, "eps_start": 0.5, "eps_end": 0.01, "eps_frac": 0.1},
    ...
    {"lr": 1e-4, "gamma": 0.99, "batch": 32, "eps_start": 1.0, "eps_end": 0.05, "eps_frac": 0.5},

    # Experiment 10 - Combined aggressive settings
    {"lr": 3e-4, "gamma": 0.90, "batch": 48, "eps_start": 1.0, "eps_end": 0.1, "eps_frac": 0.2},
]
