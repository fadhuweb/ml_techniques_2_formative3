...
print("=" * 60)
print("  BASELINE TRAINING: CNN Policy on Assault")
...
model.save("models/baseline_cnn_model")
print("\nModel saved to models/baseline_cnn_model.zip")
...
print(f"  Environment:     ALE/Assault-v5")
